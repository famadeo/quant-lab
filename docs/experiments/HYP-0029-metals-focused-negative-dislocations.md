# HYP-0029-metals-focused-negative-dislocations: Focused negative metals residual dislocations
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Focused residual-dislocation branch for negative side effects; keep as research context rather than a promoted strategy.
