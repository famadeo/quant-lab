# HYP-0039-metals-funding-adjusted-drift-backtest: Metals funding-adjusted drift pressure backtest
...
- Status: `reject`
- Owner: `famadeo`
- Decision notes: Funding-adjusted drift pressure did not produce a robust net trading strategy after realistic costs.
