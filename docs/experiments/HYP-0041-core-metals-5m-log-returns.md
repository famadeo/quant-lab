# HYP-0041-core-metals-5m-log-returns: Core metals five-minute log-return panel
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Builds and visualizes null-forward-filled 5-minute core metals returns and cumulative log returns.
