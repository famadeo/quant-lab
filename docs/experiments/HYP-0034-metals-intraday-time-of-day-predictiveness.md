# HYP-0034-metals-intraday-time-of-day-predictiveness: Core metals intraday time-of-day predictiveness
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Daily time-of-day diagnostics for individual and cross-sectional intraday metal return patterns.
