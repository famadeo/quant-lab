# HYP-0033-metals-convenience-yield-hazard-exit: Metals convenience-yield hazard-exit strategy
...
- Status: `revise`
- Owner: `famadeo`
- Decision notes: Hazard-style exits improved the basis strategy branch, but capacity and turnover constraints remain central.
