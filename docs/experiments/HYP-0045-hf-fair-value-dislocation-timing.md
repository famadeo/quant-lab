# HYP-0045-hf-fair-value-dislocation-timing: High-frequency fair-value dislocation timing
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Five-minute timing study for fair-value dislocation entries and exits before full execution modeling.
