# HYP-0037-metals-funding-vs-realized-returns: Metals funding paid versus realized returns
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Accounting study comparing realized drift against path funding paid over matched horizons.
