# HYP-0052-core-metals-drawdown-control: Core metals drawdown-control overlays
...
- Status: `revise`
- Owner: `famadeo`
- Decision notes: Daily volatility, trend, and drawdown throttles reduced max drawdown materially; soft daily throttling is the preferred risk-control candidate.
