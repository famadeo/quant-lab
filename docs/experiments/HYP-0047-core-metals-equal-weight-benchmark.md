# HYP-0047-core-metals-equal-weight-benchmark: Core metals equal-weight benchmark
...
- Status: `benchmark`
- Owner: `famadeo`
- Decision notes: One-over-N core metals benchmark from 2021 onward; this is the baseline strategy to beat.
