# HYP-0025-metals-gbdt-carry-md-backtest: Metals gradient-boosting carry and Mahalanobis backtest
...
- Status: `reject`
- Owner: `famadeo`
- Decision notes: Gradient boosting did not overcome turnover costs; best net variant was negative after costs.
