# HYP-0038-metals-funding-predictiveness: Metals funding and carry-change forward-return predictiveness
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Decile and HAC diagnostics for whether funding level or funding changes forecast forward returns.
