# HYP-0027-metals-usd-beta-hedged-vol-adjusted-returns: USD-beta-hedged vol-adjusted core metals returns
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Diagnostic visualization of core metals log returns after USD beta hedging and volatility adjustment.
