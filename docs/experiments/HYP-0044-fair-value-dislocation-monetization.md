# HYP-0044-fair-value-dislocation-monetization: Fair-value dislocation monetization
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Tests ways to monetize carry-conditioned fair-value dislocations; findings guide higher-frequency timing tests.
