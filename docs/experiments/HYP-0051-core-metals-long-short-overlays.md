# HYP-0051-core-metals-long-short-overlays: Core metals long-short overlay benchmark
...
- Status: `reject`
- Owner: `famadeo`
- Decision notes: Long-short overlays marginally reduced drawdown but did not improve net Sharpe or CAGR versus the long-only min-var candidate.
