# HYP-0031-metals-convenience-yield-basis-5m-sync: Metals convenience-yield basis with five-minute synchronized marks
...
- Status: `revise`
- Owner: `famadeo`
- Decision notes: Synchronized 5-minute carry-curve backtest improved implementation realism and motivated robust-extreme detection.
...
No conceptual description recorded.
