# HYP-0046-hf-walkforward-execution: High-frequency walk-forward execution model
...
- Status: `revise`
- Owner: `famadeo`
- Decision notes: Adds walk-forward selection and root-specific execution cost estimates; used as the cost model for later portfolio tests.
