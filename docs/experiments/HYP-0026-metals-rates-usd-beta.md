# HYP-0026-metals-rates-usd-beta: Metals beta to rates and USD factors
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Diagnostic factor-beta study for USD and rates-price exposure, used for hedging and residualization context.
