# HYP-0049-core-metals-hourly-autoregression: Core metals hourly autoregression diagnostics
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Measures hourly autoregression by metal; effects are generally weak, with PA showing the clearest negative AR signature.
