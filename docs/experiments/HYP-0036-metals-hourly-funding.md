# HYP-0036-metals-hourly-funding: Hourly metals funding from annualized curve carry
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Defines hourly metals funding as annualized futures-curve carry and builds the funding panel for later tests.
