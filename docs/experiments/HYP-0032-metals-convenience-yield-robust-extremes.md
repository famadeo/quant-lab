# HYP-0032-metals-convenience-yield-robust-extremes: Metals convenience-yield robust-extreme basis strategy
...
- Status: `revise`
- Owner: `famadeo`
- Decision notes: Robust extreme detectors improved basis signal stability; needs stronger cost, liquidity, and capacity validation.
