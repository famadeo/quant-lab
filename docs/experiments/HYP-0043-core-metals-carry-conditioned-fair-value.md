# HYP-0043-core-metals-carry-conditioned-fair-value: Core metals carry-conditioned fair value
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Defines fair value conditional on cost of carry and identifies price deviations from the carry-conditioned anchor.
