# HYP-0040-core-metals-pairwise-covariance: Core metals pairwise covariance over time
...
- Status: `research`
- Owner: `famadeo`
- Decision notes: Ten-year continuous 1-minute-derived covariance diagnostics for the core metals complex.
