# HYP-0048-core-metals-inverse-vol-benchmark: Core metals thirty-day inverse-volatility benchmark
...
- Status: `benchmark`
- Owner: `famadeo`
- Decision notes: Equal-vol adjusted long-only benchmark using trailing 30-day realized volatility.
