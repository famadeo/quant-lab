# HYP-0030-metals-convenience-yield-basis: Metals convenience-yield basis backtest
...
- Status: `revise`
- Owner: `famadeo`
- Decision notes: Initial carry-curve dislocation backtest found promising structure but required synchronized marks, robust extremes, and execution filters.
